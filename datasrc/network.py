...
ChatModes = Enum("CHAT", ["NONE", "ALL", "TEAM", "WHISPER", "SINGLE", "SINGLE_TEAM", "ATEVERYONE", "LOCAL", "WHISPER_SEND", "WHISPER_RECV"])
...
CharacterFlags = Flags("CHARACTERFLAG", ["SOLO", "JETPACK", "NO_COLLISION", "ENDLESS_HOOK", "ENDLESS_JUMP", "SUPER",
				  ...
				  "NO_MOVEMENTS", "IN_FREEZE", "PRACTICE_MODE", "LOCK_MODE", "TEAM0_MODE"])
