...
| 242 | Door and Projectile Hammer | Switch | ID=0, Delay=1: Give door hammmer to open doors by hitting, Delay=2: Give projectile hammer to redirect projectiles by hitting, Delay=3: Give both |
