...
MACRO_CONFIG_STR(SvRconExclusive, sv_rcon_exclusive, 512, "", CFGFLAG_SERVER, "Comma separated exclusive rcon ips (or 'mods' for moderators)", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(EcMaxTries, ec_max_tries, 3, 1, 100, CFGFLAG_SAVE|CFGFLAG_ECON, "Maximum number of tries for external console authentication", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvTeam, sv_team, 4, 0, 4, CFGFLAG_SERVER|CFGFLAG_GAME, "Teams configuration (0=off, 1=optional, 2=required, 3=random team per tee, 4=off except '/block')", AUTHED_ADMIN)
