...
CHttpRequest::CHttpRequest(const char *pUrl, bool Debug)
{
...
int CHttpRequest::RunImpl(CURL *pUser)
{
	...
	curl_easy_setopt(pHandle, CURLOPT_USERAGENT, GAME_NAME " " VERSION_RELEASE " (" CONF_PLATFORM_STRING "; " CONF_ARCH_STRING ")");
