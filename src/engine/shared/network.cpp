...
// TODO: rename this function
int CNetBase::UnpackPacket(NETADDR *pAddr, unsigned char *pBuffer, CNetPacketConstruct *pPacket, bool *Sevendown, CNetServer *pNetServer)
{
	...
	if (pNetServer)
		*Sevendown = pNetServer->GetSevendown(pAddr, pPacket);
	...
	if(pPacket->m_Flags&NET_PACKETFLAG_CONTROL && !*Sevendown)
	{
