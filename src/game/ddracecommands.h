...
CONSOLE_COMMAND("totele", "i[number]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConToTeleporter, this, "Teleports you to teleporter v", AUTHED_ADMIN)
CONSOLE_COMMAND("totelecp", "i[number]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConToCheckTeleporter, this, "Teleports you to checkpoint teleporter v", AUTHED_ADMIN)
CONSOLE_COMMAND("tele", "?v[id] ?i[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConTeleport, this, "Teleports player v to player i", AUTHED_ADMIN)
CONSOLE_COMMAND("addweapon", "i[weapon-id] ?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConAddWeapon, this, "Gives weapon i to player v, or spread weapon", AUTHED_ADMIN)
CONSOLE_COMMAND("removeweapon", "i[weapon-id] ?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConRemoveWeapon, this, "Removes weapon i from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("shotgun", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConShotgun, this, "Gives a shotgun to player v, or spread shotgun", AUTHED_ADMIN)
CONSOLE_COMMAND("grenade", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConGrenade, this, "Gives a grenade launcher to player v, or spread grenade", AUTHED_ADMIN)
CONSOLE_COMMAND("rifle", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConRifle, this, "Gives a rifle to player v, or spread rifle", AUTHED_ADMIN)
CONSOLE_COMMAND("weapons", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConWeapons, this, "Gives all weapons to player v, or spread weapons", AUTHED_ADMIN)
CONSOLE_COMMAND("unshotgun", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnShotgun, this, "Takes the shotgun from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("ungrenade", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnGrenade, this, "Takes the grenade launcher player v", AUTHED_ADMIN)
CONSOLE_COMMAND("unrifle", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnRifle, this, "Takes the rifle from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("unweapons", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnWeapons, this, "Takes all weapons from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("ninja", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConNinja, this, "Makes player v a ninja", AUTHED_ADMIN)
CONSOLE_COMMAND("super", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConSuper, this, "Makes player v super", AUTHED_ADMIN)
CONSOLE_COMMAND("unsuper", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnSuper, this, "Removes super from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("unsolo", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnSolo, this, "Puts player v out of solo part", AUTHED_ADMIN)
CONSOLE_COMMAND("undeep", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnDeep, this, "Puts player v out of deep freeze", AUTHED_ADMIN)
CONSOLE_COMMAND("left", "", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConGoLeft, this, "Makes you move 1 tile left", AUTHED_ADMIN)
CONSOLE_COMMAND("right", "", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConGoRight, this, "Makes you move 1 tile right", AUTHED_ADMIN)
CONSOLE_COMMAND("up", "", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConGoUp, this, "Makes you move 1 tile up", AUTHED_ADMIN)
CONSOLE_COMMAND("down", "", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConGoDown, this, "Makes you move 1 tile down", AUTHED_ADMIN)

CONSOLE_COMMAND("move", "i[x] i[y]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConMove, this, "Moves to the tile with x/y-number ii", AUTHED_ADMIN)
CONSOLE_COMMAND("move_raw", "i[x] i[y]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConMoveRaw, this, "Moves to the point with x/y-coordinates ii", AUTHED_ADMIN)
...
CONSOLE_COMMAND("plasmarifle", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConPlasmaRifle, this, "Gives a plasma rifle to player v, or spread plasma rifle", AUTHED_ADMIN)
CONSOLE_COMMAND("unplasmarifle", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnPlasmaRifle, this, "Takes the plasma rifle from player v", AUTHED_ADMIN)
...
CONSOLE_COMMAND("telekinesis", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConTelekinesis, this, "Gives telekinses power to player v", AUTHED_ADMIN)
CONSOLE_COMMAND("untelekinesis", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnTelekinesis, this, "Takes telekinses power from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("lightsaber", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConLightsaber, this, "Gives a lightsaber to player v", AUTHED_ADMIN)
CONSOLE_COMMAND("unlightsaber", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnLightsaber, this, "Takes the lightsaber from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("telerifle", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConTeleRifle, this, "Gives a tele rifle to player v", AUTHED_ADMIN)
CONSOLE_COMMAND("untelerifle", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnTeleRifle, this, "Takes the tele rifle from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("projectilerifle", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConProjectileRifle, this, "Gives a projectile rifle to player v", AUTHED_ADMIN)
CONSOLE_COMMAND("unprojectilerifle", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnProjectileRifle, this, "Takes the projectile rifle from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("ballgrenade", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConBallGrenade, this, "Gives a ball grenade to player v", AUTHED_ADMIN)
CONSOLE_COMMAND("unballgrenade", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnBallGrenade, this, "Takes the ball grenade from player v", AUTHED_ADMIN)

CONSOLE_COMMAND("hammer", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConHammer, this, "Gives a hammer to player v", AUTHED_ADMIN)
CONSOLE_COMMAND("gun", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConGun, this, "Gives a gun to player v, or spread gun", AUTHED_ADMIN)
CONSOLE_COMMAND("unhammer", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnHammer, this, "Takes the hammer from player v", AUTHED_ADMIN)
CONSOLE_COMMAND("ungun", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConUnGun, this, "Takes the gun from player v", AUTHED_ADMIN)

CONSOLE_COMMAND("scrollninja", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConScrollNinja, this, "Gives a ninja to player v", AUTHED_ADMIN)
...
CONSOLE_COMMAND("invisible", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConInvisible, this, "Toggles invisibility for player v", AUTHED_ADMIN)

CONSOLE_COMMAND("hookpower", "?s[power] ?v[id]", CFGFLAG_SERVER, ConHookPower, this, "Sets hook power for player v", AUTHED_ADMIN)
CONSOLE_COMMAND("freezehammer", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConFreezeHammer, this, "Toggles freeze hammer for player v", AUTHED_ADMIN)

CONSOLE_COMMAND("infinitejumps", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConInfiniteJumps, this, "Toggles infinite jumps for player v", AUTHED_ADMIN)
CONSOLE_COMMAND("endlesshook", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConEndlessHook, this, "Toggles endlesshook for player v", AUTHED_ADMIN)
CONSOLE_COMMAND("jetpack", "?v[id]", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConJetpack, this, "Toggles jetpack for player v", AUTHED_ADMIN)
