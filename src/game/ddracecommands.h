...
CONSOLE_COMMAND("weapons", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST|CFGFLAG_CHAT, ConWeapons, this, "Gives all weapons to player v, or spread weapons", AUTHED_NO)
...
CONSOLE_COMMAND("mute", "", CFGFLAG_SERVER|CFGFLAG_CHAT, ConMute, this, "", AUTHED_MOD)
CONSOLE_COMMAND("muteid", "v[id] i[seconds] ?r[reason]", CFGFLAG_SERVER|CFGFLAG_CHAT, ConMuteID, this, "", AUTHED_NO)
...
CONSOLE_COMMAND("helicopter", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConHelicopter, this, "Spawns a helicopter at position of player v", AUTHED_ADMIN)
