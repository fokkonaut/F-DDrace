...
enum
{
	...
	TILE_SWITCHTOGGLE = 28, // this one is same as speedup tile, so it wouldnt show anything ingame. perfect. thats why we dont use 26 here
...
public:
	struct SInfo
	{
		SInfo(int Index, int Number, int Flags)
		{
			m_Index = Index;
			m_Number = Number;
			m_Flags = Flags;
