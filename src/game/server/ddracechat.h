...
CHAT_COMMAND("me", "r[message]", CFGFLAG_CHAT, ConMe, this, "Like the famous irc command '/me says hi' will display '<yourname> says hi'", AUTHED_NO)
...
CHAT_COMMAND("saytime", "?r[player name]", CFGFLAG_CHAT, ConSayTime, this, "Privately messages someone's current time in this current running race (your time by default)", AUTHED_NO)
CHAT_COMMAND("saytimeall", "", CFGFLAG_CHAT, ConSayTimeAll, this, "Publicly messages everyone your current time in this current running race", AUTHED_NO)
