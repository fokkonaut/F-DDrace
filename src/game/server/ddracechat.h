...
CHAT_COMMAND("accountinfo", "", CFGFLAG_CHAT, ConAccountInfo, this, "Shows information about accounts")
...
CHAT_COMMAND("smoothfreeze", "", CFGFLAG_CHAT, ConSmoothFreeze, this, "Fix buggy tee when moving in freeze")
