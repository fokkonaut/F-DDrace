...
#include <game/server/entities/interactive/vehicle/helicopter.h>
#include <game/server/entities/weapons/projectile.h>
#include <game/server/entities/weapons/missile.h>
