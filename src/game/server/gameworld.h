...
struct SNotTheseEntities
{
	...
	SNotTheseEntities(CEntity* pSingleEntity)
	{
		m_pSingleEntity = pSingleEntity;
		m_apExcludeEntities = &m_pSingleEntity;
		m_NumEntities = 1;
	}
	SNotTheseEntities(CEntity** apEntities, int NumEntities)
	{
...
public:
	...
	*/
	...
	CEntity *IntersectEntityTypes(vec2 Pos0, vec2 Pos1, float Radius, vec2& NewPos, const SNotTheseEntities& NotThese, int CollideWith, int64 Types,
