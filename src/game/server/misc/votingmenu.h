...
class CVotingMenu
{
	...
	enum
	{
		...
		PREVFLAG_MISC_NOWEAPONFIX = 1 << 9,
		// VIP
		PREVFLAG_ACC_VIP_RAINBOW = 1 << 10,
		PREVFLAG_ACC_VIP_BLOODY = 1 << 11,
		PREVFLAG_ACC_VIP_ATOM = 1 << 12,
		PREVFLAG_ACC_VIP_TRAIL = 1 << 13,
		PREVFLAG_ACC_VIP_SPREADGUN = 1 << 14,
		// VIP Plus
		PREVFLAG_ACC_VIP_PLUS_RAINBOWHOOK = 1 << 15,
		PREVFLAG_ACC_VIP_PLUS_ROTATINGBALL = 1 << 16,
		PREVFLAG_ACC_VIP_PLUS_EPICCIRCLE = 1 << 17,
		PREVFLAG_ACC_VIP_PLUS_LOVELY = 1 << 18,
		PREVFLAG_ACC_VIP_PLUS_RAINBOWNAME = 1 << 19,
		PREVFLAG_ACC_VIP_PLUS_SPARKLE = 1 << 20,
		// Acc Misc
		PREVFLAG_ACC_MISC_SILENTFARM = 1 << 21,
		PREVFLAG_ACC_NINJAJETPACK = 1 << 22,
		// Acc Plot
		PREVFLAG_PLOT_SPAWN = 1 << 23,
		// Resend when no plus xp is found (means no flag and no moneytile)
		PREVFLAG_ISPLUSXP = 1 << 24,
	};
