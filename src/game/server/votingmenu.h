...
class CVotingMenu
{
	...
	enum
	{
		...
		// VIP
		PREVFLAG_ACC_VIP_RAINBOW = 1 << 7,
		PREVFLAG_ACC_VIP_BLOODY = 1 << 8,
		PREVFLAG_ACC_VIP_ATOM = 1 << 9,
		PREVFLAG_ACC_VIP_TRAIL = 1 << 10,
		PREVFLAG_ACC_VIP_SPREADGUN = 1 << 11,
		// VIP Plus
		PREVFLAG_ACC_VIP_PLUS_RAINBOWHOOK = 1 << 12,
		PREVFLAG_ACC_VIP_PLUS_ROTATINGBALL = 1 << 13,
		PREVFLAG_ACC_VIP_PLUS_EPICCIRCLE = 1 << 14,
		PREVFLAG_ACC_VIP_PLUS_LOVELY = 1 << 15,
		PREVFLAG_ACC_VIP_PLUS_RAINBOWNAME = 1 << 16,
		PREVFLAG_ACC_VIP_PLUS_SPARKLE = 1 << 17,
		// Acc Misc
		PREVFLAG_ACC_MISC_SILENTFARM = 1 << 18,
		PREVFLAG_ACC_NINJAJETPACK = 1 << 19,
		// Acc Plot
		PREVFLAG_PLOT_SPAWN = 1 << 20,
		// Resend when no plus xp is found (means no flag and no moneytile)
		PREVFLAG_ISPLUSXP = 1 << 21,
	};
