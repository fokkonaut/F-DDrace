...
MACRO_CONFIG_INT(SvBrowserScoreFix, sv_browser_score_fix, 0, 0, 1, CFGFLAG_SERVER, "Whether server tries to make clients display score correctly in browser", AUTHED_ADMIN)
