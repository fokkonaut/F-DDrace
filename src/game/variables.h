...
MACRO_CONFIG_INT(SvPortalRadius, sv_portal_radius, 54, 0, 1024, CFGFLAG_SERVER, "The radius of a portal for portal rifles (hitbox size, visual size is 1/4 block smaller)", AUTHED_ADMIN)
