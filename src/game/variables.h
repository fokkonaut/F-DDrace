...
MACRO_CONFIG_STR(SvMoneyhistoryFilePath, sv_moneyhistory_file_path, 128, "money", CFGFLAG_SAVE|CFGFLAG_CLIENT|CFGFLAG_SERVER, "The path to money history files (relative to dumps dir)", AUTHED_ADMIN)
