...
MACRO_CONFIG_INT(SvPlotDoorCloseEmpty, sv_plot_door_close_empty, 0, 0, 1, CFGFLAG_SERVER, "Whether the plot has to be clear from tees in order to close", AUTHED_ADMIN)
#endif
