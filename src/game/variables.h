...
MACRO_CONFIG_STR(SvBuildingsFilePath, sv_buildings_file_path, 128, "data/buildings", CFGFLAG_SERVER, "The path where the server searches the draweditor buildings file", AUTHED_ADMIN)
