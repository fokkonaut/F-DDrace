...
MACRO_CONFIG_INT(SvMoneyXpBombDelay, sv_money_xp_bomb_delay, 60, 1, 9999, CFGFLAG_SERVER|CFGFLAG_GAME, "Time in seconds a player has to wait to collect money-xp bomb again", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvFreeDrawTransformLevel, sv_free_draw_transform_level, AUTHED_ADMIN, AUTHED_NO, NUM_AUTHEDS-1, CFGFLAG_SERVER, "Required auth level to use transform in editor in free draw", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvDnsblBanSilent, sv_dnsbl_ban_silent, 0, 0, 1, CFGFLAG_SERVER, "Whether ban is silent or announced", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvTelerifleTelekinesisNerf, sv_telerifle_telekinesis_nerf, 1, 0, 1, CFGFLAG_SERVER|CFGFLAG_GAME, "Whether telekinesis and telerifle are handled like teleweapons (avoid skipping more tiles)", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvLoadMapConfigFile, sv_load_map_config_file, 0, 0, 1, CFGFLAG_SERVER, "Whether to execute 'maps/<sv_map>.map.cfg' as map settings aswell", AUTHED_ADMIN)
#endif
