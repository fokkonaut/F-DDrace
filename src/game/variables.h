...
MACRO_CONFIG_STR(SvRedirectServerTilePorts, sv_redirect_server_tile_ports, 128, "1:8305", CFGFLAG_SERVER, "Comma separated list of switch number to port mapping (e.g. 1:8305,2:8307)", AUTHED_ADMIN)
