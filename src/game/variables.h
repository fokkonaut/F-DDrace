...
// zombie
MACRO_CONFIG_INT(SvSpawnAsZombie, sv_spawn_as_zombie, 0, 0, 2, CFGFLAG_SERVER|CFGFLAG_GAME, "Whether player respawn as zombie by default (2=server bots too)", AUTHED_ADMIN)
